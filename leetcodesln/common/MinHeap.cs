...
namespace leetcodesln.common
{
    public class MinHeap<T> where T : IComparable<T>
    {
        private int heapSize = 0;

        private readonly int heapCapacity = 0;

        private readonly List<T> heap = null;

        private readonly Dictionary<T, HashSet<int>> map = new Dictionary<T, HashSet<int>>();
