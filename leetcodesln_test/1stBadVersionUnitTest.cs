...
{
    [TestClass]
    public class _1stBadVersionUnitTest
    {
        [TestMethod, Timeout(20_000)]
        public void UnitTest1()
        {
            var init = new _1stBadVersion(5, 4);
            var expected = 4;
        ...
        {
            var init = new _1stBadVersion(6, 3);
            var expected = 3;
        ...
        {
            var init = new _1stBadVersion(1, 1);
            var expected = 1;
        ...
        {
            var init = new _1stBadVersion(2, 1);
            var expected = 1;
        ...
        {
            var init = new _1stBadVersion(2, 2);
            var expected = 2;
            var actual = init.FirstBadVersion(2);
            Assert.AreEqual(expected, actual);
        }
